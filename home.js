...
var $author$project$Home$LinkClicked = function (a) {
	return {$: 'LinkClicked', a: a};
};
var $author$project$Home$UrlChanged = function (a) {
						...
						_Utils_update(
							model,
							{
								url: _Utils_update(
									url,
									{
										fragment: $elm$core$Maybe$Just('start')
									})
							}),
						$elm$core$Platform$Cmd$none);
				} else {
...
var $author$project$Home$homeView = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
...
var $author$project$Home$view = function (model) {
	return {
		body: _List_fromArray(
			[
				$author$project$Home$homeView(model)
			]),
		title: 'Spotify Klon'
	};
};
var $author$project$Home$main = $elm$browser$Browser$application(
	{
		init: $author$project$Home$init,
		onUrlChange: $author$project$Home$UrlChanged,
		onUrlRequest: $author$project$Home$LinkClicked,
